...
def getResponse(ints, intents_json):
    ...
    for i in list_of_intents:
        if i['tag'] == tag:
            ...
            elif tag == 'program_studi':
                result = {
                    'text': random.choice(i['responses']),
                    'buttons': ['Teknik Elektro', 'Teknik Mesin', 'Teknik Sipil', 'Teknologi Informasi', 'Administrasi Bisnis', 'Akuntansi', 'Pariwisata']
                }
            else:
                result = {'text': random.choice(i['responses'])}
            break
    return result
...
def serve_photo(filename):
    return send_from_directory('C:/Users/chady/Downloads/chatbo/photo', filename)
